function [ EPat, W ] = WALMPatEstimation( NL_mat, Self_arr, Sigma_arr, CurPat, Par )
...
for  i      =  1 : length(Self_arr)                                 % For each keypatch group
    ...
    E_Temp 	=   WWNNM_ALM( Temp, Sigma_arr(NL_mat(1:Par.patnum,i)), M_Temp, Par ); % Sigma_arr(Self_arr(i))
